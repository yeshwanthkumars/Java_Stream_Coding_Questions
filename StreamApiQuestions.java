...
public class StreamApiQuestions{
	...
	public static void main(String args[]){
		...
		*/
		...
		/*
		106.Write a program to find the sum of all elements in a list using Java Stream API
		*/
		
		System.out.println("1.Sum of all elements " + numbers.stream().mapToInt(Integer::intValue).sum());
		System.out.println("1.Sum of all elements " + numbers.stream().reduce(0, Integer::sum));
